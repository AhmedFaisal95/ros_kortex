...
# +++
from kinova_sim_obstacle_avoidance.kinova_arm_controller import KinovaArmController
...
class ExampleInitializeGazeboRobot(object):
  ...
  def __init__(self):
    ...
    # +++
    self.kinova_controller = KinovaArmController()
...
def main():
  try:
    ...
    if success:
      ...
      # +++
      success &= example.prepare_the_robot()
